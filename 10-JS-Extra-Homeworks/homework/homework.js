...
function sortArray(arr) {
  ...
  //Escribe tu código aquí
  arr.sort(function(primer_elem, segundo_elem){
    return primer_elem.length - segundo_elem.length
  });
  return arr;
}
...
function buscoInterseccion(arreglo1, arreglo2){
  ...
  //Escribe tu código aquí 
  return arreglo1.filter(function(elem) {
    return arreglo2.indexOf(elem) >= 0
  }); 
}
